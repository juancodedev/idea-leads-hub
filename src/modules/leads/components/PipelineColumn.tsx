...
export function PipelineColumn({ status, leads }: PipelineColumnProps) {
  ...
  return (
    <div className="flex w-80 flex-shrink-0 flex-col rounded-lg bg-slate-100/50 p-4 dark:bg-slate-900/50">
